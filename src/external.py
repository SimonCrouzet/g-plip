...
def ProteinName_to_UniProtID(protein_name):
    ...
    url = "https://rest.uniprot.org/uniprotkb/search?fields=accession%2Cid%2Cprotein_name&format=tsv&query=%28%28protein_name%3A%22{}%22%29%20AND%20%28organism_id%3A9606%29%20AND%20%28reviewed%3Atrue%29%29&size=500".format(
        protein_name.replace(" ", "%20")
    )
    df = pd.read_csv(url, delimiter="\t")
